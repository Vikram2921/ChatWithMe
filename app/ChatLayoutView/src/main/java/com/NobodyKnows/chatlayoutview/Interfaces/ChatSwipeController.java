...
public class ChatSwipeController extends ItemTouchHelper.Callback {
    ...
    private CSwipControllersActions mSwipeControllerActions;
    ...
    public ChatSwipeController(Context context,CSwipControllersActions swipControllersActions) {
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive){
        if(mSwipeControllerActions.canSwipe(viewHolder.getAdapterPosition())) {
